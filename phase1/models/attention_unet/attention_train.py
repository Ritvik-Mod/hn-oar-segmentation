...
def main():
    ...
    save_dir     = '/home/<hpc-user>/project/checkpoints/attention_unet'
    ...
    if os.path.exists(checkpoint_path):
        ...
        # Safely load scheduler and scaler if they exist in the checkpoint
    ...
    for epoch in range(start_epoch, NUM_EPOCHS + 1):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save({
                ...
                'scaler_state_dict':    scaler.state_dict(),    # ADDED
                'val_loss':             val_loss,
            }, checkpoint_path)
        ...
        # Save history after every epoch (survives walltime kills)
        history_path = os.path.join(save_dir, 'training_history.json')
