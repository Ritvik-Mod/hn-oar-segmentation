...
from dataloader_e6 import PATCH
...
def main():
    ...
    ap.add_argument("--labels-ts", default=LABELS_TS,
                    help="dir with Dataset002 labelsTs (for per-case affine); "
                         "override on the pod where the ../../ path doesn't exist")
